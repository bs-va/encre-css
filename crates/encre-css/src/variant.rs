...
pub enum Variant {
    ...
    // Parent(&'static str),
    WrapSelector(&'static str),
    AtRule(&'static str),
}

lazy_static! {
    pub static ref VARIANTS: BTreeMap<&'static str, Variant> = {
        ...
        variants.insert("marker", Variant::WrapSelector("& *::marker, &::marker"));
        variants.insert("selection", Variant::WrapSelector("& *::selection, &::selection"));
        ...
        variants.insert("open", Variant::WrapSelector("&[open]"));

        // --- Direction ---

        variants.insert("ltr", Variant::WrapSelector("[dir=\"ltr\"] &"));
        variants.insert("rtl", Variant::WrapSelector("[dir=\"rtl\"] &"));
