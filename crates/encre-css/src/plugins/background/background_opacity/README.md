...
<table style="display: table;">
  ...
  <tbody>
    <tr><td>bg-opacity-<i>&lt;integer&gt;</i></td><td>--en-bg-opacity: <i>&lt;integer / 100&gt;</i>;</td></tr>
  </tbody>
</table>

### Deprecation notice

This utility is **deprecated** and the [new opacity syntax](crate::plugins::background::background_color#note-about-the-opacity-syntax)
